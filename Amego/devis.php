...
function concat(&$amego, &$client,&$deux, $what, $val, $default = 0) {
  $res = $_POST[$val];
        ...
        <form data-toggle="validator" method="POST" role="form" action="sendMail.php">
          ...
          <div class="col-lg-6 col-lg-offset-3">
            ...
            <div class="panel panel-warning">
              ...
              <div class="panel-body">
                <textarea id="devisComment" name="devisComment" class="form-control" rows="8" placeholder="Détaillez votre déménagement, plus vous donnerez des informations précises, plus le devis de votre demenagement sera précis"><?php
                  ...
                  if (isset($_GET['alacarte'])) {
                    ...
                    concat($amego, $client,$deux, "Emballage  des articles  non  fragiles (Linge plier, livres, DVD...) ", "emarticle");
                    concat($amego, $client,$deux, "Emballage de la  vaisselles  fragiles  ", "emvaisselles", 2);
                    concat($amego, $client,$deux, "Mise en penderie des vêtements sur cintre  ", "penderie", 2);
                    concat($amego, $client,$deux, "Emballage des objets fragiles ( cadre, miroir, tableau ...) ", "emobjfragile", 2);
                    concat($amego, $client,$deux, "Protection et conditionnnement  du mobilier", "protcond", 2);
                    concat($amego, $client,$deux, "Protection sous hausse des sommiers, matelas, canapés, fauteuils ...  ", "profaut", 2);
                    concat($amego, $client,$deux, "Demontage et Remontage des  meubles imposant ( lit , dressing, living ...) ", "demontage", 2);
                    concat($amego, $client,$deux, "Démarche pour autorisation de stationnement  ", "demautris", 2);
                    ...
                    if($_POST['needmontmeuble']=="on"){
                      ...
                      $autre = $autre .' - '."Je n'ai pas besoin  d'un Monte Meuble \n";
                    }
