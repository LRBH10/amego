...
<script type="text/javascript">
  var paper = Raphael("paper3", 800, 800);
  ...
  var pie = paper.piechart(330, 330, 300, [5, 95], {colors:["#a2bf2f","#2f69bf"],legendpos:"south",legend: ["Client", "Amego"], startFromFixedAngle: 90});

  var text3 = paper.text(300, 150, "Les effets personnels ").attr(font);
  text3.rotate("75");

  var text3 = paper.text(180, 280, "Emballage  des articles  non \n fragiles \n(Linge plier, livres, DVD...)  ").attr(font2);
  var text1 = paper.text(420, 100, "Emballage de la \n vaisselles  fragiles  ").attr(font2);
  var text21 = paper.text(450, 150, "Mise en penderie \ndes vêtements sur cintre  ").attr(font2);
