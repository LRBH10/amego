...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <img class="img-responsive" src="<?php echo IMAGESITE;?>conseils.jpg">
            </div>
        ...
        <div class="row">        
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>eau.gif" alt="image" class="img-thumbnail"></dt>
                <dd>                    
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>laposte.gif" alt="image" class="img-thumbnail"></dt>
                <dd><br/>
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>cpam.gif" alt="image" class="img-thumbnail"></dt>
                <dd>
                    <p><br/>Prévenez votre caisse d'assurance maladie de votre changement d'adresse et demander un transfert du dossier.</p>
                </dd>
            </dl>
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>caf.gif" alt="image" class="img-thumbnail"></dt>
                <dd>
                    <br/>
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>mairie.gif" alt="image" class="img-thumbnail"></dt>
                <dd>
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>voiture.gif" alt="image" class="img-thumbnail"></dt>
                <dd>
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>impots.gif" alt="image" class="img-thumbnail"></dt>
                <dd>
                    <br/>
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>telephone.gif" alt="image" class="img-thumbnail"></dt>
                <dd>
                    <br/>
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>banque.gif" alt="image" class="img-thumbnail"></dt>
                <dd>
            ...
            <dl class="dl-horizontal">
                <dt><img src="<?php echo IMAGESITE;?>edf-gdf.gif" alt="image" class="img-thumbnail"></dt>
                <dd>                    
